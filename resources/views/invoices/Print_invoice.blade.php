                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>برنامج تحصيل فواتير </h6>
                                <p>2022 Something St, Zarqa Town, Country Jordan<br>
                                    <br>
                                    Email: hamza@companyname.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Programmer Hamza Abu Qwaider </h6>
                                    <p>Zarqa Road, Amman Jordan, @copy 2022<br>
